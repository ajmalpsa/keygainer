...
<body>
						...
						<span id="print"></span>
							...
							<div class="control-group">
								<div class="controls row-fluid">
									<input class="span12" type="email" id="username" placeholder="Enter Email-id">
								</div>
							</div>
						...
						<div class="module-foot">
							<div class="control-group">
								<div class="controls clearfix">
									<button type="button" class="btn btn-primary pull-right" onclick="servsend()">Reset Password</button>
	...
	<script type="text/javascript">
          ...
          function servsend(){
        	  ...
        	  var url = "/KeyGainer/resetpass?mail="+username;
