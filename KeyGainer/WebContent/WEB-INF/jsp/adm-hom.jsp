                ...
                <div class="container">
                    ...
                    <div class="nav-collapse collapse navbar-inverse-collapse">
                        <ul class="nav nav-icons">
                            <li class="active"><a href="feedbacks"><i class="icon-envelope"></i> <span class="label label-success">4</span></a></li>
                        ...
                        <ul class="nav pull-right">
                            <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Users
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="all-user">All Users</a></li>
                                    <li><a href="apr-user">Approval Pending</a></li>
